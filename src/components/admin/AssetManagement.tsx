...
import { Plus, Search, Edit, Trash2, Download, Upload, Package } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Manage both digital assets and physical rental equipment.</p>
      </div>
